...
public class Tool1 : MonoBehaviour {
	...
	public void CactusIncrease () {
		...
		if ((int)(monsAbility [0].weeds * 100) >= s) {
			restCount++;
		}
	}
	public void BlueIncrease () {
		int s = Random.Range (0, 100);
		if ((int)(monsAbility [1].weeds * 100) >= s) {
			restCount++;
		}
	}
	public void GoldIncrease () {
		int s = Random.Range (0, 100);
		if ((int)(monsAbility [2].weeds * 100) >= s) {
			restCount++;
		}
	}
	public void GreenIncrease () {
		int s = Random.Range (0, 100);
		if ((int)(monsAbility [3].weeds * 100) >= s) {
			restCount++;
		}
	}
	public void RedIncrease () {
		int s = Random.Range (0, 100);
		if ((int)(monsAbility [4].weeds * 100) >= s) {
			restCount++;
		}
	}
	public void BOSSIncrease () {
		int s = Random.Range (0, 100);
		if ((int)(monsAbility [5].weeds * 100) >= s) {
			restCount++;
		}
	}
	public void RhinoIncrease () {
		int s = Random.Range (0, 100);
		if ((int)(monsAbility [6].weeds * 100) >= s) {
			restCount++;
		}
	}
}
